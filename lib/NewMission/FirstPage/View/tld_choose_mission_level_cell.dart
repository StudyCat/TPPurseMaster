...
class TLDChooseMissionLevelCell extends StatefulWidget {
  TLDChooseMissionLevelCell({Key key,this.levelModel}) : super(key: key);

  final TLDMissionLevelModel levelModel;

  @override
  _TLDChooseMissionLevelCellState createState() => _TLDChooseMissionLevelCellState();
}

class _TLDChooseMissionLevelCellState extends State<TLDChooseMissionLevelCell> {
  @override
