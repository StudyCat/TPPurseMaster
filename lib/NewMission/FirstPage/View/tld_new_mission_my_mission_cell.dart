...
class TLDNewMissionMyMissionCell extends StatefulWidget {
  TLDNewMissionMyMissionCell({Key key,this.model,this.didClickItemCallBack,this.didClickIMBtnCallBack}) : super(key: key);

  
  final Function didClickItemCallBack;

  final TLDOrderListModel model;

  final Function didClickIMBtnCallBack;


  @override
  _TLDNewMissionMyMissionCellState createState() => _TLDNewMissionMyMissionCellState();
}

class _TLDNewMissionMyMissionCellState extends State<TLDNewMissionMyMissionCell> {
  @override
