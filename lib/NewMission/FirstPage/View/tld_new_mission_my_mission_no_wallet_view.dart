...
class TLDNewMissionMyMissionNoWalletView extends StatefulWidget {
  TLDNewMissionMyMissionNoWalletView({Key key,this.didClickChooseBtnCallBack}) : super(key: key);

  final Function didClickChooseBtnCallBack;

  @override
  _TLDNewMissionMyMissionNoWalletViewState createState() => _TLDNewMissionMyMissionNoWalletViewState();
}

class _TLDNewMissionMyMissionNoWalletViewState extends State<TLDNewMissionMyMissionNoWalletView> {
 @override
