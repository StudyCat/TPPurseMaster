...
class TLDNewMissionChooseMissionLevelPage extends StatefulWidget {
  TLDNewMissionChooseMissionLevelPage({Key key,this.didChooseLevelCallBack}) : super(key: key);

  final Function(TLDMissionLevelModel) didChooseLevelCallBack;

  @override
  _TLDNewMissionChooseMissionLevelPageState createState() => _TLDNewMissionChooseMissionLevelPageState();
}

class _TLDNewMissionChooseMissionLevelPageState extends State<TLDNewMissionChooseMissionLevelPage> {
  List _dataSource = [];

  StreamController _streamController;

  TLDNewMissionChooseMissionLevelModelManager _modelManager;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();

    _modelManager = TLDNewMissionChooseMissionLevelModelManager();
  ...
  Widget build(BuildContext context) {
    ...
    return TLDEmptyListView(
      ...
      getEmptyViewCallBack: (){
        return TLDEmptyDataView(imageAsset: 'assetss/images/no_data.png',title: '暂无数据',);
      },
  ...
  Widget _getListViewItem(BuildContext context, int index) {
      TLDMissionLevelModel model = _dataSource[index];
      return GestureDetector(
        onTap: (){
          widget.didChooseLevelCallBack(model);
          Navigator.of(context).pop();
        },
        child: TLDChooseMissionLevelCell(levelModel : model),
      );
  }
