...
class TLDNewMissionFirstPage extends StatefulWidget {
  TLDNewMissionFirstPage({Key key}) : super(key: key);

  @override
  _TLDNewMissionFirstPageState createState() => _TLDNewMissionFirstPageState();
}
...
class _TLDNewMissionFirstPageState extends State<TLDNewMissionFirstPage> with AutomaticKeepAliveClientMixin ,TickerProviderStateMixin {
  ...
  TLDNewMissionPageControl _control;
  ...
  TLDNewMissionFirstPageModelManager _modelManager;
  ...
  void initState() {
    ...
    _modelManager = TLDNewMissionFirstPageModelManager();
  ...
  _getWalletInfo(String walletAddress){
    ...
    _modelManager.getWalletInfo(walletAddress, (TLDWalletInfoModel infoModel){
      if (mounted){
        setState(() {
  ...
  void _getTabControlAndPage(){
    ...
    _tabTitles = [
     ...
     _pages = [TLDNewMissionDealMissionPage(walletAddress: _infoModel.walletAddress,control: _control,getProgressCallBack: (String progress){
       if(_progress != progress){
         setState(() {
          _progress = progress;
       });
       }
     },),TLDNewMissionMyMissionPage(walletAddress:_infoModel.walletAddress,corntrol: _control,),TLDNewMissionPublishMissionPage(walletAddress:_infoModel.walletAddress,corntrol: _control)];
     ...
     },),TLDNewMissionMyMissionPage(walletAddress:_infoModel.walletAddress,corntrol: _control,)];
    }
  ...
  Widget _getNoWalletWidget(){
    return TLDNewMissionMyMissionNoWalletView(didClickChooseBtnCallBack: (){
      _chooseWallet();
    },);
  }
