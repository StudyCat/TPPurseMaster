...
class TLDNewMissionMyMissionPage extends StatefulWidget {
  TLDNewMissionMyMissionPage({Key key,this.walletAddress,this.corntrol}) : super(key: key);
  ...
  @override
  _TLDNewMissionMyMissionPageState createState() => _TLDNewMissionMyMissionPageState();
}

class _TLDNewMissionMyMissionPageState extends State<TLDNewMissionMyMissionPage> with AutomaticKeepAliveClientMixin {

  List _dataSource = [];

  TLDNewMissionMyMissionModelManager _modelManager;
  ...
  void initState() {
    ...
    _modelManager = TLDNewMissionMyMissionModelManager();
  ...
  Widget _getBodyWidget(){
     return TLDEmptyListView(getListViewCellCallBack: (int index){
      TLDOrderListModel infoModel = _dataSource[index];
       return TLDNewMissionMyMissionCell(
         model: infoModel,
