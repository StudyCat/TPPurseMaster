...
class TLDJustNoticeVoteCell extends StatefulWidget {
  TLDJustNoticeVoteCell({Key key,this.title,this.didVoteCallBack}) : super(key: key);
  ...
  @override
  _TLDJustNoticeVoteCellState createState() => _TLDJustNoticeVoteCellState();
}

class _TLDJustNoticeVoteCellState extends State<TLDJustNoticeVoteCell> {
  int _vote = 0;
