...
class TLDPurseSettingCell extends StatefulWidget {
  TLDPurseSettingCell({Key key,this.title,this.didClickCallBack}) : super(key: key);
  ...
  @override
  _TLDPurseSettingCellState createState() => _TLDPurseSettingCellState();
}

class _TLDPurseSettingCellState extends State<TLDPurseSettingCell> {
  @override
