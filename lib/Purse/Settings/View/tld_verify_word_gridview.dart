...
class TLDVerifyWordGridView extends StatefulWidget {
  TLDVerifyWordGridView({Key key,this.currentedIndex,this.words,this.didClickItem}) : super(key: key);

  final int currentedIndex;
  final List words;
  final ValueChanged<int> didClickItem;
  @override
  _TLDVerifyWordGridViewState createState() => _TLDVerifyWordGridViewState();
}

class _TLDVerifyWordGridViewState extends State<TLDVerifyWordGridView> {
  @override
