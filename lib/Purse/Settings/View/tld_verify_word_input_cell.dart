...
class TLDVerifyWordInputCell extends StatefulWidget {
  TLDVerifyWordInputCell({Key key,this.words}) : super(key: key);

  final List  words;

  @override
  _TLDVerifyWordInputCellState createState() => _TLDVerifyWordInputCellState();
}

class _TLDVerifyWordInputCellState extends State<TLDVerifyWordInputCell> {
  @override
