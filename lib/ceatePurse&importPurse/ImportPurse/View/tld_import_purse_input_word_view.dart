...
class TLDImportPurseInputWordView extends StatefulWidget {
  TLDImportPurseInputWordView({Key key,this.textFieldEditingWithIndexCallBack}) : super(key: key);

  final Function(String value,int index) textFieldEditingWithIndexCallBack;

  @override
  _TLDImportPurseInputWordViewState createState() => _TLDImportPurseInputWordViewState();
}

class _TLDImportPurseInputWordViewState extends State<TLDImportPurseInputWordView> {
  @override
