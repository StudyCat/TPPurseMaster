...
class TLDIMUserTimeImageMessageCell extends StatefulWidget {
  TLDIMUserTimeImageMessageCell({Key key,this.imageUrl,this.createTime}) : super(key: key);
  ...
  @override
  _TLDIMUserTimeImageMessageCellState createState() => _TLDIMUserTimeImageMessageCellState();
}

class _TLDIMUserTimeImageMessageCellState extends State<TLDIMUserTimeImageMessageCell> {
  @override
