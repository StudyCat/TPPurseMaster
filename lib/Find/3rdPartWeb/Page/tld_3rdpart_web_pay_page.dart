...
class TLD3rdPartWebPayPage extends StatefulWidget {
  TLD3rdPartWebPayPage({Key key,this.amount,this.walletAddress,this.orderInfo,this.didClickPayBtnCallBack,this.didClickCancelBtn}) : super(key: key);
  ...
  final Function(TLDTranferAmountPramaterModel) didClickPayBtnCallBack;

  final Function() didClickCancelBtn;

  @override
  _TLD3rdPartWebPayPageState createState() => _TLD3rdPartWebPayPageState();
}

class _TLD3rdPartWebPayPageState extends State<TLD3rdPartWebPayPage> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            children: <InlineSpan>[TextSpan(text: 'TLD',style: TextStyle(fontSize : ScreenUtil().setSp(28),color : Color.fromARGB(255, 51, 51, 51)))]),
          ),
          ),
           Padding(
            padding: EdgeInsets.only(top: ScreenUtil().setHeight(32)),
