...
class TLDRankMineHeaderCell extends StatefulWidget {
  TLDRankMineHeaderCell({Key key}) : super(key: key);

  @override
  _TLDRankMineHeaderCellState createState() => _TLDRankMineHeaderCellState();
}

class _TLDRankMineHeaderCellState extends State<TLDRankMineHeaderCell> {
 @override
