...
class TLDRankAcceptanceCell extends StatefulWidget {
  TLDRankAcceptanceCell({Key key,this.rankModel}) : super(key: key);

  final TLDAcceptanceRankModel rankModel;

  @override
  _TLDRankAcceptanceCellState createState() => _TLDRankAcceptanceCellState();
}

class _TLDRankAcceptanceCellState extends State<TLDRankAcceptanceCell> {
  @override
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            width : (MediaQuery.of(context).size.width - ScreenUtil().setWidth(60)) / 3,
            child:  Text('${widget.rankModel.profitQuota}TLD',style: textStyle,textAlign: TextAlign.center,), 
         )
        ],
      ),
    );
