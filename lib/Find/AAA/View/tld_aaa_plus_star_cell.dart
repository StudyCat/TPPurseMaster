...
class TLDAAAPlusStarCell extends StatefulWidget {
  TLDAAAPlusStarCell({Key key,this.starModel,this.didClickPlusStarButton}) : super(key: key);
  
  final TLDTeamStarModel starModel;

  final Function didClickPlusStarButton;

  @override
  _TLDAAAPlusStarCellState createState() => _TLDAAAPlusStarCellState();
}

class _TLDAAAPlusStarCellState extends State<TLDAAAPlusStarCell> {
  @override
           ...
           Container(
                 ...
                 child : RichText(
                   ...
                   text: TextSpan(
                     ...
                     children: <InlineSpan>[
                     TextSpan(
                     text: '(${widget.starModel.addProfit}TLD)',
