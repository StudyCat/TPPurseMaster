...
class TLDAcceptanceInvitationDetailHeaderCell extends StatefulWidget {
  TLDAcceptanceInvitationDetailHeaderCell({Key key, this.detailEarningModel})
      : super(key: key);

  final TLDInviteDetailEarningModel detailEarningModel;

  @override
  _TLDAcceptanceInvitationDetailHeaderCellState createState() =>
      _TLDAcceptanceInvitationDetailHeaderCellState();
}

class _TLDAcceptanceInvitationDetailHeaderCellState
    extends State<TLDAcceptanceInvitationDetailHeaderCell> {
  List _tapCountList;
