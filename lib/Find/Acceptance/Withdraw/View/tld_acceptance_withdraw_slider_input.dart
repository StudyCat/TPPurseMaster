...
class TLDAcceptanceWithdrawSliderInputCell extends StatefulWidget {
  TLDAcceptanceWithdrawSliderInputCell({Key key,this.title,this.inputCallBack,this.focusNode,this.maxValue}) : super(key: key);
  final String title;
  final String maxValue;
  final Function(String) inputCallBack;
  final FocusNode focusNode;
  @override
  _TLDAcceptanceWithdrawSliderInputCellState createState() => _TLDAcceptanceWithdrawSliderInputCellState();
}

class _TLDAcceptanceWithdrawSliderInputCellState extends State<TLDAcceptanceWithdrawSliderInputCell> {
 String _value = '0';
  ...
  Widget getTextField(){
    return Stack(
      ...
      enabled: widget.maxValue == null ? false : true,
