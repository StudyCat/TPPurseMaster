  ...
  TLDBillInfoListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['orderList'] != null) {
      ...
      json['orderList'].forEach((v) {
        orderList.add(new TLDApptanceOrderListModel.fromJson(v));
      });
    }
  }
...
class TLDApptanceOrderListModel {
  int acptOrderId;
  String acptOrderNo;
  int billId;
  String billPrice;
  ...
  TLDApptanceOrderListModel.fromJson(Map<String, dynamic> json) {
...
class TLDAcceptanceBillListModelManager {
  void getBillList(Function(List) success,Function(TLDError) failure){
    TLDBaseRequest request = TLDBaseRequest({},'acpt/bill/billList');
    request.postNetRequest((value) {
      List dataList = value;
      List result = [];
      for (Map item in dataList) {
        result.add(TLDBillInfoListModel.fromJson(item));
      }
      success(result);
    }, (error) => failure(error));
  }
