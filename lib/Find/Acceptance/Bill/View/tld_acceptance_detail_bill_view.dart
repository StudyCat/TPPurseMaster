      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _getBillInfoRowView('票据剩余有效期','${widget.detailOrderInfoModel.billExpireDayCount}天'),
            _getBillInfoRowView('每天静态收益增加','${widget.detailOrderInfoModel.staticProfit}TLD'),
            ...
            _getBillInfoRowView('购买时间',formatDate(DateTime.fromMillisecondsSinceEpoch(int.parse(widget.detailOrderInfoModel.createTime)), [yyyy,'.',mm,'.',dd,' ',HH,':',nn,':',ss])),
