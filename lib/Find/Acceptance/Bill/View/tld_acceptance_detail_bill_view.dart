      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _getBillInfoRowView(I18n.of(context).dailyStaticProfitAdd,'${widget.detailOrderInfoModel.staticProfit}TLD'),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Column(
            children : <Widget>[
              Text( I18n.of(context).univalence + ' ${widget.detailOrderInfoModel.billPrice}TLD',
              style: TextStyle(
                  color: Color.fromARGB(255, 102, 102, 102),
                  fontSize: ScreenUtil().setSp(28))),
              Padding(
                padding : EdgeInsets.only(top: ScreenUtil().setHeight(14)),
                child : Text( I18n.of(context).totalPrices + ' ${widget.detailOrderInfoModel.totalPrice}TLD',
              style: TextStyle(
                  color: Color.fromARGB(255, 102, 102, 102),
                  fontSize: ScreenUtil().setSp(28)))
              )
