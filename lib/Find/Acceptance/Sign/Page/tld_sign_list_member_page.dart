...
class TLDSignListMemberPage extends StatefulWidget {
  TLDSignListMemberPage({Key key}) : super(key: key);

  @override
  _TLDSignListMemberPageState createState() => _TLDSignListMemberPageState();
}

class _TLDSignListMemberPageState extends State<TLDSignListMemberPage> {

  TLDSignListMemberModelManager _modelManager;
  ...
  void initState() {
    ...
    _modelManager = TLDSignListMemberModelManager();
    _getSignList(_page);
  }
 ...
 return SmartRefresher(
  ...
  Widget _getBodyWidget(){
    return ListView.builder(
      ...
      return TLDSignListMemberCell(model: _dataSource[index],);
     },
    );
  }
