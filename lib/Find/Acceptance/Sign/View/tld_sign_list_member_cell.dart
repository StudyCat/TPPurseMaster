...
class TLDSignListMemberCell extends StatefulWidget {
  TLDSignListMemberCell({Key key,this.model}) : super(key: key);

  final TLDSignMemberModel model;

  @override
  _TLDSignListMemberCellState createState() => _TLDSignListMemberCellState();
}

class _TLDSignListMemberCellState extends State<TLDSignListMemberCell> {
  @override
    ...
    return  Container(
                 ...
                 child : RichText(
                   ...
                   text: TextSpan(
                     ...
                     style: TextStyle(fontSize: ScreenUtil().setSp(24),color: Color.fromARGB(255, 153, 153, 153)),),
                     TextSpan(
                     text: '(${widget.model.signProfitCount}TLD)',
                     style: TextStyle(fontSize: ScreenUtil().setSp(24),color: Color.fromARGB(255, 51, 51, 51)),),
                     ]
                   ),
                 )
