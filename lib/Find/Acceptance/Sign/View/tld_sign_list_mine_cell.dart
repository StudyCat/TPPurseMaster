...
class TLDSignListMineCell extends StatefulWidget {
  TLDSignListMineCell({Key key,this.model}) : super(key: key);

  final TLDSignMineModel model;

  @override
  _TLDSignListMineCellState createState() => _TLDSignListMineCellState();
}

class _TLDSignListMineCellState extends State<TLDSignListMineCell> {
  @override
