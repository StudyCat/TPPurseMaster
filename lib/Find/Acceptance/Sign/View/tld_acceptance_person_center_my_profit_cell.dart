...
class TLDAcceptancePersonCenterMyProfitCell extends StatefulWidget {
  TLDAcceptancePersonCenterMyProfitCell({Key key,this.profitModel}) : super(key: key);

    final TLDAcceptancePersonCenterProfitModel profitModel;

  @override
  _TLDAcceptancePersonCenterMyProfitCellState createState() => _TLDAcceptancePersonCenterMyProfitCellState();
}

class _TLDAcceptancePersonCenterMyProfitCellState extends State<TLDAcceptancePersonCenterMyProfitCell> {
  @override
 ...
 Widget _getListView(){
    return ListView.builder(
      ...
      TLDAcceptancePersonCenterProfitSonModel sonModel = widget.profitModel.data[index];
      return Container(
