    ...
    return Container(
      ...
      children:<Widget>[
         Container(
            ...
            child: Center(
              child : Text(widget.listModel.overflowType == 1 ?  I18n.of(context).static : I18n.of(context).promotion,maxLines: 1,overflow: TextOverflow.clip,style:TextStyle(fontSize:ScreenUtil().setSp(24),color:widget.listModel.overflowType == 1 ? Color.fromARGB(255, 144, 76, 12) : Color.fromARGB(255, 65, 117, 5)))
            ),
        ),
        Padding(
