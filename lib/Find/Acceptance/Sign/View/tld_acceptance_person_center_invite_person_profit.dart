...
class TLDAcceptancePersonCenterInvitePersonProfitCell extends StatefulWidget {
  TLDAcceptancePersonCenterInvitePersonProfitCell({Key key,this.profitModel}) : super(key: key);

  final TLDAcceptancePersonCenterProfitModel profitModel;

  @override
  _TLDAcceptancePersonCenterInvitePersonProfitCellState createState() => _TLDAcceptancePersonCenterInvitePersonProfitCellState();
}

class _TLDAcceptancePersonCenterInvitePersonProfitCellState extends State<TLDAcceptancePersonCenterInvitePersonProfitCell> {
 @override
  ...
  Widget _getListView(){
    return ListView.builder(
      ...
      TLDAcceptancePersonCenterProfitSonModel sonModel = widget.profitModel.data[index - 1];
      return  Container(
