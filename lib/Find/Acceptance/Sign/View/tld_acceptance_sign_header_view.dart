...
class TLDAcceptanceSignHeaderView extends StatefulWidget {
  ...
  @override
  _TLDAcceptanceSignHeaderViewState createState() =>
      _TLDAcceptanceSignHeaderViewState();
}

class _TLDAcceptanceSignHeaderViewState
    extends State<TLDAcceptanceSignHeaderView> {
  @override
            ...
            RichText(
              text: TextSpan(
                  text: widget.userInfoModel != null
                      ? widget.userInfoModel.totalWithdraw + 'TLD'
                      : '0.0TLD',
                  style: TextStyle(
      ...
      child: Container(
        ...
        child:
          ...
          _getSingleProfitWidget(
              ...
              widget.userInfoModel != null
                  ? '${widget.userInfoModel.overflowProfit}TLD'
                  : '0.0TLD'),
          Padding(
          ...
          _getSingleProfitWidget(
              ...
              widget.userInfoModel != null
                  ? '${widget.userInfoModel.totalBillProfit}TLD'
                  : '0.0TLD')
        ]),
      ),
    );
