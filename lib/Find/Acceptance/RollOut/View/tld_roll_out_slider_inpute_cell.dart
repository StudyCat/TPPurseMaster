...
class TLDRollOutSliderInputeCell extends StatefulWidget {
  TLDRollOutSliderInputeCell({Key key,this.title,this.maxValue,this.inputCallBack,this.focusNode,this.minValue}) : super(key: key);
  ...
  @override
  _TLDRollOutSliderInputeCellState createState() => _TLDRollOutSliderInputeCellState();
}

class _TLDRollOutSliderInputeCellState extends State<TLDRollOutSliderInputeCell> {
  String _value;
