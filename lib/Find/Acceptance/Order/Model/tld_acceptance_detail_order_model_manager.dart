...
class TLDAcceptanceDetailOrderInfoModel {
  int acptOrderId;
  String acptOrderNo;
  int billId;
  String billPrice;
  ...
  TLDAcceptanceDetailOrderInfoModel(
      {this.acptOrderId,
      this.acptOrderNo,
      this.billId,
      this.billPrice,
  ...
  TLDAcceptanceDetailOrderInfoModel.fromJson(Map<String, dynamic> json) {
...
class TLDAcceptanceDetailOrderModelManager {
   void getDetailOrderInfo(String orderNo,Function(TLDAcceptanceDetailOrderInfoModel) success,Function(TLDError) failure){
     TLDBaseRequest request = TLDBaseRequest({'acptOrderNo':orderNo}, 'acpt/order/billOrderDetail');
     request.postNetRequest((value) {
       TLDAcceptanceDetailOrderInfoModel detailOrderInfoModel = TLDAcceptanceDetailOrderInfoModel.fromJson(value);
