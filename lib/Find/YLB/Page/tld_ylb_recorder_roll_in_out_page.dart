...
class TLDYLBRecorderRollInOutPage extends StatefulWidget {
  TLDYLBRecorderRollInOutPage({Key key, this.type}) : super(key: key);

  final int type; //1为转入，2为转出

  @override
  _TLDYLBRecorderRollInOutPageState createState() =>
      _TLDYLBRecorderRollInOutPageState();
}

class _TLDYLBRecorderRollInOutPageState
    extends State<TLDYLBRecorderRollInOutPage> {
  TLDYLBRecorderRollInOutModelManager _modelManager;
  ...
  void initState() {
    ...
    _modelManager = TLDYLBRecorderRollInOutModelManager();
  ...
  Widget _getBodyWidget() {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return TLDYLBRecorderRollInOutCell(type: widget.type,profitListModel: _dataSource[index],);
      },
    );
  }
}
