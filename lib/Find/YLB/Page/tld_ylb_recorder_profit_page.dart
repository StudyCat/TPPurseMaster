...
class TLDYLBRecorderProfitPage extends StatefulWidget {
  TLDYLBRecorderProfitPage({Key key}) : super(key: key);

  @override
  _TLDYLBRecorderProfitPageState createState() => _TLDYLBRecorderProfitPageState();
}

class _TLDYLBRecorderProfitPageState extends State<TLDYLBRecorderProfitPage> {

  TLDYLBRecorderProfitModelManager _modelManager;
  ...
  void initState() {
    ...
    _modelManager = TLDYLBRecorderProfitModelManager();
  ...
  Widget _getBodyWidget(){
    return ListView.builder(
      ...
      return TLDYLBRecorderProfitCell(listModel: _dataSource[index],);
     },
    );
  }
}