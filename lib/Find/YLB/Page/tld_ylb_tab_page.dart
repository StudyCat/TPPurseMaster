...
class TLDYLBTabPage extends StatefulWidget {
  TLDYLBTabPage({Key key}) : super(key: key);

  @override
  _TLDYLBTabPageState createState() => _TLDYLBTabPageState();
}

class _TLDYLBTabPageState extends State<TLDYLBTabPage> {
  ...
  void initState() {
    ...
    pages =  [TLDYLBBalancePage(),TLDYLBRecorderPage()];
  }
