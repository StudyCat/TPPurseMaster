...
class TLDYLBRecorderRollInOutCell extends StatefulWidget {
  TLDYLBRecorderRollInOutCell({Key key,this.type,this.profitListModel}) : super(key: key);

  final int type; //1为转入，2为转出

  final TLDYLBProfitListModel profitListModel;

  @override
  _TLDYLBRecorderRollInOutCellState createState() => _TLDYLBRecorderRollInOutCellState();
}

class _TLDYLBRecorderRollInOutCellState extends State<TLDYLBRecorderRollInOutCell> {
  ...
  Widget _getContentWidget(){
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Text( symbol + '${widget.profitListModel.tldCount}TLD',textAlign: TextAlign.center,style : TextStyle(color: Color.fromARGB(255, 51, 51, 51),fontSize: ScreenUtil().setSp(32)))
      ],
    );
  }
