...
class TLDDetailRedEnvelopeHeaderCell extends StatefulWidget {
  TLDDetailRedEnvelopeHeaderCell({Key key,this.detailRedEnvelopeModel}) : super(key: key);
