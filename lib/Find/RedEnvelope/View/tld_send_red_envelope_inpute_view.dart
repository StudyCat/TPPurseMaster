...
enum TLDRedEnvelopType { spellLuck, quota }
...
class TLDSendRedEnvelopeInputeView extends StatefulWidget {
  ...
  @override
  _TLDSendRedEnvelopeInputeViewState createState() =>
      _TLDSendRedEnvelopeInputeViewState();
}

class _TLDSendRedEnvelopeInputeViewState
    extends State<TLDSendRedEnvelopeInputeView> {
      ...
      child: Row(children: <Widget>[
        Padding(
          ...
          child: _getSingleChoiceWidget(
              TLDRedEnvelopType.spellLuck, I18n.of(context).spellLuck),
        ),
        Padding(
          padding: EdgeInsets.only(left: ScreenUtil().setWidth(30)),
          child: _getSingleChoiceWidget(
              TLDRedEnvelopType.quota, I18n.of(context).quotaRedEnvelope),
        )
      ]),
    );
  }
