...
class TLDDetailRecieveRedEnvelopeHeaderCell extends StatefulWidget {
  TLDDetailRecieveRedEnvelopeHeaderCell({Key key,this.detailRedEnvelopeModel}) : super(key: key);

  final TLDDetailRedEnvelopeModel detailRedEnvelopeModel;

  @override
  _TLDDetailRecieveRedEnvelopeHeaderCellState createState() => _TLDDetailRecieveRedEnvelopeHeaderCellState();
}

class _TLDDetailRecieveRedEnvelopeHeaderCellState extends State<TLDDetailRecieveRedEnvelopeHeaderCell> {
  @override
