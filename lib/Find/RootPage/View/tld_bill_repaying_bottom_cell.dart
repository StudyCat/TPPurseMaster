...
class TLDBillRepayingBottomCell extends StatefulWidget {
  TLDBillRepayingBottomCell({Key key,this.repayingModel,this.didClickClearButton}) : super(key: key);

  final TLDBillRepayingModel repayingModel;

  final Function didClickClearButton;

  @override
  _TLDBillRepayingBottomCellState createState() => _TLDBillRepayingBottomCellState();
}

class _TLDBillRepayingBottomCellState extends State<TLDBillRepayingBottomCell> {
  @override
