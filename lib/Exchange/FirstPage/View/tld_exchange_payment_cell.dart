...
class TLDExchangePaymentCell extends StatefulWidget {
  TLDExchangePaymentCell({Key key,this.paymentModel,this.didClickItemCallBack}) : super(key: key);
  ...
  @override
  _TLDExchangePaymentCellState createState() => _TLDExchangePaymentCellState();
}

class _TLDExchangePaymentCellState extends State<TLDExchangePaymentCell> {
  @override
      ...
      child: Padding(
       ...
       child: Container(
         ...
         child: Row(
           ...
           children: <Widget>[
             Text('收款方式',style : TextStyle(color : Color.fromARGB(255, 51, 51, 51),fontSize: ScreenUtil().setSp(24))),
