...
class TLDQuickBuyView extends StatefulWidget {
  TLDQuickBuyView(
      {Key key,
      this.focusNode,
      this.textDidChange,
  ...
  @override
  _TLDQuickBuyViewState createState() => _TLDQuickBuyViewState();
}

class _TLDQuickBuyViewState extends State<TLDQuickBuyView> {
  @override
