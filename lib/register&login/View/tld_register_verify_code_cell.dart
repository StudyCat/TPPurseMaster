...
class TLDRegisterVerifyCodeCell extends StatefulWidget {
  TLDRegisterVerifyCodeCell({Key key,this.didClickSendCodeBtnCallBack,this.codeDidChangeCallBack}) : super(key: key);
  ...
  @override
  _TLDRegisterVerifyCodeCellState createState() => _TLDRegisterVerifyCodeCellState();
}

class _TLDRegisterVerifyCodeCellState extends State<TLDRegisterVerifyCodeCell> {
  ...
  void initState() {
    ...
    _cellPhoneSusbscription = eventBus.on<TLDRegisterCellPhoneChangeEvent>().listen((event) {
