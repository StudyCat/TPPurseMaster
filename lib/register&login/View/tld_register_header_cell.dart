...
class TLDRegisterHeaderCell extends StatefulWidget {
  TLDRegisterHeaderCell({Key key}) : super(key: key);

  @override
  _TLDRegisterHeaderCellState createState() => _TLDRegisterHeaderCellState();
}

class _TLDRegisterHeaderCellState extends State<TLDRegisterHeaderCell> {
  @override
