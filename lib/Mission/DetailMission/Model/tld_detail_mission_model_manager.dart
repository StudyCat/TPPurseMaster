...
class TLDDetailMissionInfoModel {
  String taskNo;
  int taskLevel;
  String levelIcon;
  ...
  TLDDetailMissionInfoModel.fromJson(Map<String, dynamic> json) {
    taskNo = json['taskNo'];
...
class TLDDetailMissionModelManager{

  void getDetailMissionInfo(int taskWalletId,Function(TLDDetailMissionInfoModel) success,Function(TLDError) failure){
    TLDBaseRequest request = TLDBaseRequest({'taskWalletId':taskWalletId},'task/taskDetail');
    request.postNetRequest((value) {
      Map data = value;
      success(TLDDetailMissionInfoModel.fromJson(data));
    }, (error) => failure(error));
  }
}