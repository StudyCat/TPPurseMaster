...
class TLDMissionFirstWalletCell extends StatefulWidget {
  TLDMissionFirstWalletCell({Key key,this.didClickItemCallBack}) : super(key: key);

  final Function didClickItemCallBack;

  @override
  _TLDMissionFirstWalletCellState createState() => _TLDMissionFirstWalletCellState();
}

class _TLDMissionFirstWalletCellState extends State<TLDMissionFirstWalletCell> {
  @override
               ...
               Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text('423.324 344 34TLD',style: TextStyle(color: Theme.of(context).primaryColor,fontSize: ScreenUtil().setSp(36)),),
                      ),
                      Container(
