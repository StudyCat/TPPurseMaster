...
class TLDPaymentManagerCell extends StatefulWidget {
  TLDPaymentManagerCell({Key key,this.paymentModel,this.didClickItemCallBack}) : super(key: key);
  ...
  _TLDPaymentManagerCellState createState() => _TLDPaymentManagerCellState();
}


class _TLDPaymentManagerCellState extends State<TLDPaymentManagerCell> {
  @override
