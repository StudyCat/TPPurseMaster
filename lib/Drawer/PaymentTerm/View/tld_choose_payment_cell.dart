...
class TLDChoosePaymentCell extends StatefulWidget {
  TLDChoosePaymentCell({Key key,this.title,this.didClickCallBack,this.iconInt}) : super(key: key);
  ...
  @override
  _TLDChoosePaymentCellState createState() => _TLDChoosePaymentCellState();
}

class _TLDChoosePaymentCellState extends State<TLDChoosePaymentCell> {
  @override
